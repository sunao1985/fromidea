---
description: 每个JavaScript工程师都应懂的33个概念,每个JavaScript开发者都应该懂的33个概念
---
...
![每位 JS 开发应该懂的 33 个概念](./assets/33_js_concepts.jpg)

>   项目地址：[github](https://github.com/stephentian/33-js-concepts)
